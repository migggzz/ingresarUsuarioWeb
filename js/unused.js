...
// const found4 = arr2.find(elem => elem.nombre === elec);
            ...
            function agregarBody(){
                ...
                document.write(`<button onclick="imprimirArregloFinal(arr2)">Haz Click Para Buscar Ver La Lista</button> <br> <br>`);
                document.write(`<button onclick="removeSessionStorage()">Haz Click Para eliminar el arreglo en session storage</button> <br>`);
            }
